                                                 ...
                                                 withNewApnsDeviceToken:(NSData *)newApnsDeviceToken
{
    [self.application stub:@selector(registerForRemoteNotificationTypes:) withBlock:^id(NSArray *params) {
        if ([self.applicationDelegate respondsToSelector:@selector(application:didRegisterForRemoteNotificationsWithDeviceToken:)]) {
            [(CFAppDelegate *)self.applicationDelegate application:self.application
...
{
    self.params = [CFPushParameters parametersForNotificationTypes:notificationTypes
...
{
    self.params = [CFPushParameters parametersForNotificationTypes:self.params.remoteNotificationTypes
...
- (void)setupDefaultSavedParameters
{
    ...
    [CFPushPersistentStorage setAPNSDeviceToken:self.apnsDeviceToken];
    [CFPushPersistentStorage setBackEndDeviceID:self.backEndDeviceId];
}
