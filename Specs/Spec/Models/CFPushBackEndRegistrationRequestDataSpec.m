//
//  CFPushBackEndRegistrationRequestDataSpec.mm
//  CFPushSDK
//
...
#import "CFPushBackEndRegistrationRequestDataTest.h"
#import "CFPushErrors.h"

SPEC_BEGIN(CFPushBackEndRegistrationRequestDataSpec)

describe(@"CFPushBackEndRegistrationRequestData", ^{
    
    __block CFPushRegistrationRequestData *model;
    ...
    it(@"should be initializable", ^{
        model = [[CFPushRegistrationRequestData alloc] init];
    ...
    context(@"deserialization", ^{
        ...
        it(@"should handle a nil input", ^{
            NSError *error;
            model = [CFPushRegistrationRequestData fromJSONData:nil error:&error];
            [[model  should] beNil];
        ...
        it(@"should handle empty input", ^{
            NSError *error;
            model = [CFPushRegistrationRequestData fromJSONData:[NSData data] error:&error];
            [[model should] beNil];
            [[error shouldNot] beNil];
            [[error.domain should] equal:CFPushErrorDomain];
            [[theValue(error.code) should] equal:theValue(CFPushBackEndRegistrationDataUnparseable)];
        ...
        it(@"should handle bad JSON", ^{
            ...
            model = [CFPushRegistrationRequestData fromJSONData:JSONData error:&error];
            [[model  should] beNil];
            [[error shouldNot] beNil];
        });
        ...
        it(@"should construct a complete request object", ^{
            ...
            model = [CFPushRegistrationRequestData fromJSONData:data error:&error];
            [[error should] beNil];
            [[model.os should] equal:TEST_OS];
