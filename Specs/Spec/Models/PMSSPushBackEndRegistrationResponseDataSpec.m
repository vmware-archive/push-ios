//
//  PMSSPushBackEndRegistrationResponseDataSpec.mm
//  PMSSPushSDK
//
...
SPEC_BEGIN(PMSSPushBackEndRegistrationResponseDataSpec)

describe(@"PMSSPushBackEndRegistrationResponseData", ^{
    
    __block PMSSPushRegistrationResponseData *model;
    ...
    it(@"should be initializable", ^{
        model = [[PMSSPushRegistrationResponseData alloc] init];
    ...
    context(@"deserialization", ^{
        ...
        it(@"should handle a nil input", ^{
            NSError *error;
            model = [PMSSPushRegistrationResponseData pmss_fromJSONData:nil error:&error];
            [[model should] beNil];
        ...
        it(@"should handle empty input", ^{
            NSError *error;
            model = [PMSSPushRegistrationResponseData pmss_fromJSONData:[NSData data] error:&error];
            [[model should] beNil];
            [[error shouldNot] beNil];
            [[error.domain should] equal:PMSSPushErrorDomain];
            [[theValue(error.code) should] equal:theValue(PMSSPushBackEndRegistrationDataUnparseable)];
        ...
        it(@"should handle bad JSON", ^{
            ...
            model = [PMSSPushRegistrationResponseData pmss_fromJSONData:JSONData error:&error];
            [[model should] beNil];
            [[error shouldNot] beNil];
        });
        ...
        it(@"should construct a complete response object", ^{
            ...
            model = [PMSSPushRegistrationResponseData pmss_fromJSONData:data error:&error];
            [[error should] beNil];
            [[model.os should] equal:TEST_OS];
