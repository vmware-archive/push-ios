...
SPEC_BEGIN(MSSPushBackEndRegistrationPutRequestDataSpec)

describe(@"MSSPushBackEndRegistrationPutRequestData", ^{
    
    __block MSSPushRegistrationPutRequestData *model;
    ...
    it(@"should be initializable", ^{
        model = [[MSSPushRegistrationPutRequestData alloc] init];
    ...
    context(@"deserialization", ^{
        ...
        it(@"should handle a nil input", ^{
            NSError *error;
            model = [MSSPushRegistrationPutRequestData mss_fromJSONData:nil error:&error];
            [[model  should] beNil];
        ...
        it(@"should handle empty input", ^{
            NSError *error;
            model = [MSSPushRegistrationPutRequestData mss_fromJSONData:[NSData data] error:&error];
            [[model should] beNil];
            [[error shouldNot] beNil];
            [[error.domain should] equal:MSSPushErrorDomain];
            [[theValue(error.code) should] equal:theValue(MSSPushBackEndRegistrationDataUnparseable)];
        ...
        it(@"should handle bad JSON", ^{
            ...
            model = [MSSPushRegistrationPutRequestData mss_fromJSONData:JSONData error:&error];
            [[model  should] beNil];
            [[error shouldNot] beNil];
        });
        ...
        it(@"should construct a complete request object", ^{
            ...
            model = [MSSPushRegistrationPutRequestData mss_fromJSONData:data error:&error];
            [[error should] beNil];
            [[model.os should] equal:TEST_OS];
