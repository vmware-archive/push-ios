...
OBJC_EXPORT NSString *const TEST_CUSTOM_USER_ID_1;
...
OBJC_EXPORT NSString *const TEST_CUSTOM_USER_ID;
...
@property NSSet<NSString*> *tags1;
@property NSSet<NSString*> *tags2;
