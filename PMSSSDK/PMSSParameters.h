 ...
 * Pass to one of the `register` methods in the `PMSSPushSDK` class.
 */
@interface PMSSParameters : NSObject
...
/**
 * Creates an instance using the values set in the `PMSSParameters.plist` file.
 */
