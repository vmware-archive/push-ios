...
PMSSPushLogListener listener = nil;


@implementation PMSSPushDebug
...
+ (void)setLogListener:(PMSSPushLogListener)_listener {
    listener = _listener;
}
